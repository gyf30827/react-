    ...
    resolve: {
      ...
      alias: {
        ...
        "use-sync-external-store": path.resolve(
          __dirname,
          "../src/react/packages/use-sync-external-store"
        ),
        redux: path.resolve(__dirname, "../src/redux/src/index.ts"),
        // "redux-toolkit": path.resolve(
        //   __dirname,
        //   "../src/redux-toolkit/packages/toolkit"
        // ),

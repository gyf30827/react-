...
export function prepareForCommit(containerInfo: Container): Object | null {
  // 将是否允许派发事件放置到全局变量 eventsEnabled
...
// 创建dom元素
// 将该 dom 元素对应的Fiber节点和 props 赋值到 dom元素上
export function createInstance(
  ...
  // 将Fiber节点赋值到dom元素的属性 [internalInstanceKey] 上
  precacheFiberNode(internalInstanceHandle, domElement);
  // 将 props 赋值到dom元素的 [internalPropsKey]属性上
...
export function getCurrentEventPriority(): * {
  ...
  console.log('getCurrentEventPriority', '获取事件优先级', currentEvent);

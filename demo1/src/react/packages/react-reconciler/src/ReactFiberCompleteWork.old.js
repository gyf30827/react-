...
if (supportsMutation) {
  ...
  updateHostComponent = function (
    ...
    // console.log('updateHostComponent', type, newProps, oldProps === newProps);
    ...
    // related to `hidden`.
    // 待更新的操作 结构 [propKey, change, propkey,change]
...
function bubbleProperties(completedWork: Fiber) {
  // console.log('completeWork', 'bubbleProperties');
  // 是否执行了优化策略，只有在更新阶段才会出现，子节点没有没有变化
  const didBailout =
...
function completeWork(
  ...
  switch (workInProgress.tag) {
    ...
    case HostRoot: {
      ...
      // console.log('completeWork', 'HostRoot', current);
    ...
    case HostComponent: {
      ...
      if (current !== null && workInProgress.stateNode != null) {
        ...
        if (wasHydrated) {
          ...
          // 遍历当前Fiber节点将其子节点对应的dom元素添加到当前Fiber节点的dom元素中
          appendAllChildren(instance, workInProgress, false, false);
          // 将生成的dom元素赋值到 stateNode 上
    ...
    case SuspenseComponent: {
      ...
      // 如果存在 updateQueue 即存在 待监听的promise 打上 Update 标识
    ...
    case SuspenseListComponent: {
      console.log('SuspenseListComponent');
      popSuspenseContext(workInProgress);
